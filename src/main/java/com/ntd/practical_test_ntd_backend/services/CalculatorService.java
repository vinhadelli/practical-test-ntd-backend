...
public class CalculatorService {
    ...
    public BigDecimal Addition (Long userId, BigDecimal a, BigDecimal b)
    {
        ...
        ProcessOperation(OperationTypesEnum.ADDITION, userId, String.format("SUM: {0} = {1} + {2}", result, a, b));
        return result;
    }
    ...
    public BigDecimal Subtraction (Long userId, BigDecimal a, BigDecimal b)
    {
        ...
        ProcessOperation(OperationTypesEnum.SUBTRACTION, userId, String.format("SUB: {0} = {1} - {2}", result, a, b));
        return result;
    }
    ...
    public BigDecimal Division (Long userId, BigDecimal a, BigDecimal b)
    {
        ...
        ProcessOperation(OperationTypesEnum.DIVISION, userId, String.format("DIV: {0} = {1} - {2}", result, a, b));
        return result;
    }
    ...
    public BigDecimal Multiplication (Long userId, BigDecimal a, BigDecimal b)
    {
        ...
        ProcessOperation(OperationTypesEnum.MULTIPLICATION, userId, String.format("MULT: {0} = {1} - {2}", result, a, b));
        return result;
    }
    ...
    public BigDecimal SquareRoot (Long userId, BigDecimal a)
    {
        ...
        ProcessOperation(OperationTypesEnum.SQUARE_ROOT, userId, String.format("SQROT: {0} = √{1}", result, a));
        return result;
    }
